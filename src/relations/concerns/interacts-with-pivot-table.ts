  ...
  return class extends Relation {
    ...
    async updateExistingPivot(
      ...
      if (
        ...
        return await this.updateExistingPivotUsingCustomClass(
          id,
          attributes,
          touch,
        )
    ...
    async updateExistingPivotUsingCustomClass(
      this: any,
      id: number | string,
      attributes: TGeneric,
      _touch: boolean,
    ...
    async getCurrentlyAttachedPivots() {
      ...
      return results.map((record: any) => {
        ...
        const pivot = modelClass.fromRawAttributes(
          this.parent,
          record,
          this.getTable(),
          true,
